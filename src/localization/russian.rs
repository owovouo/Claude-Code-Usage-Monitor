...
pub(super) const STRINGS: Strings = Strings {
    ...
    show_pacing: "Показывать индикатор темпа",
    lock_codex_window: "Принудительный 5-ч отсчёт Codex",
    lock_claude_code_window: "Принудительный 5-ч отсчёт Claude Code",
    quiet_hours: "Часы простоя",
    quiet_start: "Начало",
    quiet_end: "Конец",
    quiet_set_time: "Задать время...",
    quiet_clear: "Очистить",
    ok: "ОК",
    cancel: "Отмена",
    quiet_time_hint: "Формат: ЧЧ:ММ  (очистите оба поля для отключения)",
    quiet_time_error: "Заполните оба поля или оставьте оба пустыми",
};
