...
pub(super) const STRINGS: Strings = Strings {
    ...
    show_pacing: "Mostrar Indicador de Ritmo",
    lock_codex_window: "Forçar Contagem Regressiva de 5h do Codex",
    lock_claude_code_window: "Forçar Contagem Regressiva de 5h do Claude Code",
    quiet_hours: "Horário Ocioso",
    quiet_start: "Início",
    quiet_end: "Fim",
    quiet_set_time: "Definir horário...",
    quiet_clear: "Limpar",
    ok: "OK",
    cancel: "Cancelar",
    quiet_time_hint: "Formato: HH:MM  (limpe ambos para desativar)",
    quiet_time_error: "Preencha ambos os campos ou deixe ambos vazios",
};
